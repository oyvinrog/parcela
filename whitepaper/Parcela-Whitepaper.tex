...
The share file format (v2) is:
\begin{quote}
PSHARE02 (8 bytes magic)\\
...
\textless SHA-256 checksum\textgreater\ (32 bytes)
\end{quote}

The checksum covers the index and payload bytes, enabling detection of share corruption before reconstruction.
...
\bibitem{argon2} Biryukov, A., Dinu, D., \& Khovratovich, D. (2016). \textit{Argon2: The memory-hard function for password hashing and other applications}. In \textit{2016 IEEE European Symposium on Security and Privacy (EuroS\&P)} (pp. 292-302). \url{https://doi.org/10.1109/EuroSP.2016.31}
\bibitem{dworkin2007} Dworkin, M. (2007). \textit{Recommendation for block cipher modes of operation: Galois/Counter mode (GCM) and GMAC} (NIST Special Publication 800-38D). National Institute of Standards and Technology. \url{https://doi.org/10.6028/NIST.SP.800-38D}
\bibitem{shamir1979} Shamir, A. (1979). How to share a secret. \textit{Communications of the ACM, 22}(11), 612-613. \url{https://doi.org/10.1145/359168.359176}
\bibitem{parcela} oyvinrog. (n.d.). \textit{Parcela} [Source code]. GitHub. \url{https://github.com/oyvinrog/parcela}
\end{thebibliography}
